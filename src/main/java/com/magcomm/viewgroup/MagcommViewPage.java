 ...
 */
public class MagcommViewPage extends ViewPager {

    public static final String TAG = "MagcommViewPage";
    ...
    public MagcommViewPage(Context context) {
        super(context);
    }

    public MagcommViewPage(Context context, AttributeSet attrs) {
        super(context, attrs);
        setClipChildren(false);
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.MagcommViewPager);
        int effect = ta.getInt(R.styleable.MagcommViewPager_style, 0);
        String[] transitions = getResources().getStringArray(R.array.magcomm_effects);
        setTransitionEffect(TransitionEffect.valueOf(transitions[effect]));
        setFadeEnabled(ta.getBoolean(R.styleable.MagcommViewPager_fadeEnabled, false));
        setOutlineEnabled(ta.getBoolean(R.styleable.MagcommViewPager_outlineEnabled, false));
        setOutlineColor(ta.getColor(R.styleable.MagcommViewPager_outlineColor, Color.WHITE));
        switch (mEffect) {
            case Stack:
            case ZoomOut:
                setFadeEnabled(true);
